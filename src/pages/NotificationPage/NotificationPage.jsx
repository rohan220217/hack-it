...
function Tile({ text, name, time, url }) {
  return (
    <div className={styles.tile}>
      <div className={styles.avatar}>
        <img src={url} alt="user" width="100%" />
      </div>
      <h5>{name}</h5>
      <h4>{text} </h4>
      <span>{time}</span>
